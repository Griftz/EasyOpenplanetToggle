...
> [!TIP]
> If you place the script in the **Trackmania.exe** directory prior to running (can then create a shortcut elsewhere to run), it won't require a prompt to browse to the **Trackmania.exe** directory and automatically proceed to run the script.

<br/><br/>**Main Window**
* Browse - Used to browse to **Trackmania.exe** directory
